...
var oe = new Vue({
  ...
  data: {
    ...
    download: {
      latest: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.3.3/OpenEmu_2.3.3.zip',
      experimental: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.3.3/OpenEmu_2.3.3-experimental.zip'
    },
    intro: [
    ...
    controls: [
      ...
      { name: 'Xbox One S Wireless Controller' },
      { name: 'Xbox 360 & 3rd party (driver required)' },
      { name: 'SteelSeries Nimbus' },
      { name: 'SteelSeries Stratus XL' },
      { name: 'Horipad Ultimate' },
      { name: 'Retro-Bit Official Sega Genesis/Sega Saturn Bluetooth Controller 8-Button Arcade Pad' },
