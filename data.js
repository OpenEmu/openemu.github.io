...
var oe = new Vue({
  ...
  data: {
    ...
    download: {
      latest: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.0.8/OpenEmu_2.0.8.zip',
      experimental: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.0.8/OpenEmu_2.0.8-experimental.zip'
    },
    intro: [
