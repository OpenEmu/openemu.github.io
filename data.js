...
var oe = new Vue({
  ...
  data: {
    ...
    download: {
      latest: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.0.6.1/OpenEmu_2.0.6.1.zip',
      experimental: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.0.6.1/OpenEmu_2.0.6.1-experimental.zip'
    },
    intro: [
