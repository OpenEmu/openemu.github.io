...
var oe = new Vue({
  ...
  data: {
    ...
    download: {
      latest: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.3/OpenEmu_2.3.zip',
      experimental: 'https://github.com/OpenEmu/OpenEmu/releases/download/v2.3/OpenEmu_2.3-experimental.zip'
    },
    intro: [
